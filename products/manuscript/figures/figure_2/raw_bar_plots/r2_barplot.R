...
r2.table$diversity_metric <- factor(x = r2.table$diversity_metric, levels = c("richness", "evenness", "dominance", "WPC1", "WPC2", "WPC3", "UWPC1", "UWPC2", "UWPC3"))

#Group by diversity metric & fill by compartment
...
ggsave("output/r2_barplot_color_by_compartment.pdf")
...
ggsave("output/r2_barplot_color_by_compartment_grouped_by_metric.pdf")
